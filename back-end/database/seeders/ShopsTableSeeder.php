...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            ...
            'pic_path' => 'http://127.0.0.1:8000/storage/yakiniku.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 40,
            ...
            'pic_path' => 'http://127.0.0.1:8000/storage/izakaya.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 13,
            ...
            'pic_path' => 'http://127.0.0.1:8000/storage/italian.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 40,
            ...
            'pic_path' => 'http://127.0.0.1:8000/storage/ramen.jpeg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'area_id' => 13,
